    ...
    */
    ...
    public R save(@RequestBody ShangpinEntity shangpin, HttpServletRequest request){
        ...
        Wrapper<ShangpinEntity> queryWrapper = new EntityWrapper<ShangpinEntity>()
            ...
            .eq("gonghuofang_types", shangpin.getGonghuofangTypes())
            ;
...
//                            shangpinEntity.setShangpinUuidNumber(data.get(0));                    //物品编号 要改的
//                            shangpinEntity.setShangpinName(data.get(0));                    //物品名称 要改的
//                            shangpinEntity.setShangpinTypes(Integer.valueOf(data.get(0)));   //物品类型 要改的
//                            shangpinEntity.setShangpinNewMoney(data.get(0));                    //物品价格 要改的
//                            shangpinEntity.setShangpinKucunNumber(Integer.valueOf(data.get(0)));   //物品库存 要改的
//                            shangpinEntity.setGonghuofangTypes(Integer.valueOf(data.get(0)));   //供货方 要改的
//                            shangpinEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //物品编号
                        List<ShangpinEntity> shangpinEntities_shangpinUuidNumber = shangpinService.selectList(new EntityWrapper<ShangpinEntity>().in("shangpin_uuid_number", seachFields.get("shangpinUuidNumber")));
                        if(shangpinEntities_shangpinUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [物品编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
