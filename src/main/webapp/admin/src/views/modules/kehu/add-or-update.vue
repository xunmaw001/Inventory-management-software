    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="kehuPhone">
                       <el-input v-model="ruleForm.kehuPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.kehuPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="kehuEmail">
                       <el-input v-model="ruleForm.kehuEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.kehuEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="邮箱" prop="kehuEmail">
                           <el-input v-model="ruleForm.kehuEmail"
