            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '物品名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinName" placeholder="物品名称" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '物品类型' : ''">
                        <el-select v-model="searchForm.shangpinTypes" placeholder="请选择物品类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/kucuenguanliruanjian/upload/shangpinMuBan.xls"
                        >批量导入物品信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      ...
                                      label="物品库存">
                        <template slot-scope="scope">
							<div :style="scope.row.shangpinKucunNumber <= 10?'backgroundColor:red;borderRadius:20px':''">
								{{scope.row.shangpinKucunNumber}}
							</div>
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="gonghuofangTypes"
                                      header-align="center"
                                      label="供货方">
                        <template slot-scope="scope">
                            {{scope.row.gonghuofangValue}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                //本表字段
                     '物品编号': "shangpinUuidNumber",
                     '物品名称': "shangpinName",
                     '物品类型': "shangpinTypes",
                     '物品价格': "shangpinNewMoney",
                     '物品库存': "shangpinKucunNumber",
                     '供货方': "gonghuofangTypes",
            },
            ...
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        sumColum : 'shangpin_kucun_number', //求和字段
